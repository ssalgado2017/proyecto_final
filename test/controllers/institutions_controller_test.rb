...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { business_name: @institution.business_name, dv: @institution.dv, rut: @institution.rut } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { business_name: @institution.business_name, dv: @institution.dv, rut: @institution.rut } }
